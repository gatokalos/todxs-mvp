...
export const BASE_CHARACTER_LAYOUT = {
  "reina-de-espadas": {
    ...
    genero_literario: "Prosa barroca alegórica",
  ...
  "don-polo": {
    ...
    genero_literario: "Ensayo dramático maquiavélico",
  ...
  saturnina: {
    ...
    genero_literario: "Crónica poética popular surreal",
  ...
  lucinda: {
    ...
    genero_literario: "Carta emocional performativa",
  ...
  "payasito-triste": {
    ...
    genero_literario: "Monólogo tragicómico escénico",
  ...
  "la-maestra": {
    ...
    genero_literario: "Ensayo breve pedagógico-poético",
    frase_base: "Enseña mejor desde la herida.",
  ...
  "la-doctora": {
    ...
    genero_literario: "Informe clínico simbólico",
  ...
  silvestre: {
    ...
    genero_literario: "Diario íntimo onírico",
  ...
  andy: {
    ...
    nombre_visible: "Andy",
    genero_literario: "Guion escénico invisible",
